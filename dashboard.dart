...
class _HomeDashboardState extends State<HomeDashboard> {
                ...
                children: [
                  ...
                  GridView.count(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.pushNamed(context, '/kerusakan');
                        },
                        child: _buildDataCard(
                          context,
                          'Form',
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success']) {
          ...
          await NotificationService.checkWaterConditions(kekeruhan, ketinggian, kodeAlat);
        }
      }
    } catch (e) {
  ...
  Widget _buildDataCard(BuildContext context, String title, String value, Color color, String route, Widget icon) {
    return Container(
